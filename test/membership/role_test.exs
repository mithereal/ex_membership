defmodule Membership.RoleTest do
  ...
  describe "Membership.Role.changeset/2" do
  ...
  describe "Membership.Role.build/3" do
  ...
  describe "Membership.Role.grant/2" do
  ...
  describe "Membership.Role.revoke/2" do
    test "rejects invalid grant" do
      assert_raise ArgumentError, fn ->
        Role.revoke(nil, nil)
      end
